...
| 项目 | 详情 |
|------|------|
| **项目名称** | 基于多模态密钥的跨模态无载体隐写方法的研究 |
| **项目作者** | Zhang Yankai（张延开） |
| **作者单位** | 暨南大学 网络空间安全学院 (College of Cyber Security, Jinan University) |
| **开发语言** | Python 3.8+ |
| **深度学习框架** | PyTorch ≥ 2.0 |
| **模型与库** | Stable Diffusion v1.5、Diffusers、Transformers |
| **核心技术** | DDIM 反演、RS 纠错编码、多模态密钥、VAE 潜空间调制、CLIP 文本引导、参考比较法提取 |
